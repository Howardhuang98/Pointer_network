...
|5|0.006658690644487206|使用beam search|b88762b|
...
test/test_model.py 文件运行结果：可以看出输入的时间戳(城市数目)分别是5，7，但是两个模型的参数量都是661760。说明模型参数与城市个数无关，可用于variable size sorting。
...
_________________________________________________________________________________
encoder (Encoder)               ((None, 5, 256), (No 265216      main_input[0][0]                 
_________________________________________________________________________________
decoder (Decoder)               (None, 5, None)      396544      main_input[0][0]                 
                                                                 encoder[0][0]                    
                                                                 encoder[0][1]                    
                                                                 encoder[0][2]                    
=================================================================================
Total params: 661,760
Trainable params: 661,760
...
_________________________________________________________________________________
encoder (Encoder)               ((None, 7, 256), (No 265216      main_input[0][0]                 
_________________________________________________________________________________
decoder (Decoder)               (None, 7, None)      396544      main_input[0][0]                 
                                                                 encoder[0][0]                    
                                                                 encoder[0][1]                    
                                                                 encoder[0][2]                    
=================================================================================
